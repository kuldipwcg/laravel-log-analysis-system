...
const ResetPassword = () => {
  return (
    // <section className="bg-[#ddeff5]">
    //   <div className="min-h-screen  bg-opacity-50 flex items-center justify-center">
    //     <div className="select-none md:m-10 lg-max:m-5  shadow-2xl rounded-6">
    //       <div className=" p-10 px-25 lg-max:p-5 bg-[#fefefe] order-1 lg-max:order-2 justify-center items-center rounded-6">
    //         <div>
    //           <h1 className="text-3xl mb-8 flex font-semibold text-wcg_blue">
    //             Forgot Password?
    //           </h1>
    //           <ResetPasswordForm />
    //         </div>
